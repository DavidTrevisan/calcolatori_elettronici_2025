...
set param_value $env(OPSIZE)

puts "--- Running synthesis flow for $param_name = $param_value "
...
# - clk frequency
###################
set output_design_name mcd_$param_name$param_value
...
eval elaborate -parameters "{{${param_name} ${param_value}}}"
...
# end foreach OPSIZE $param_value
###################
