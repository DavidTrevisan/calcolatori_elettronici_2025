...
Per confermare o smentire l'ipotesi iniziale sarebbe dunque necessaria un'analisi dettagliata della fase di chiusura del timing in sintesi, unita a uno studio approfondito del `divider`, aspetti che tuttavia esulano dagli obiettivi del presente progetto.
