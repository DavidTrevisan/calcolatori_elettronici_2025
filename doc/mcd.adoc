...
Si é rappresentato il componente `divider` come un blocco gerarchico 'a scatola nera', ossia considerandone solo il comportamento alle porte di input e di output.
